...
class WebRTCConnection {
	...
	constructor(private localUUID: string, private remoteUUID: string) {
	...
	private saveSignalingData(uuid: string, description: RTCSessionDescription | RTCSessionDescriptionInit | null) {
		if (description) {
